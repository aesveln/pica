...
ALTER TABLE "ADMPRO"."PRODUCT" ADD CONSTRAINT "PRODUCT_CITY_FK" FOREIGN KEY
	("source_city")
...
ALTER TABLE "ADMPRO"."PRODUCT" ADD CONSTRAINT "PRODUCT_CITY_FK1" FOREIGN KEY
	("target_city")
	REFERENCES "ADMPRO"."CITY"
	("Id")
	ON DELETE NO ACTION
...
ALTER TABLE "ADMPRO"."PRODUCT" DROP CONSTRAINT "PRODUCT_CITY_FK"
GO

ALTER TABLE "ADMPRO"."PRODUCT" DROP CONSTRAINT "PRODUCT_CITY_FK1"
GO
